  ...
  def __init__(self, input_dim, action_dim):
    ...
    self.main = tf.keras.Sequential([
        ...
        tf.compat.v1.layers.Dense(
            units=action_dim,
            activation='tanh',
            kernel_initializer=tf.compat.v1.orthogonal_initializer(0.01))
    ])
...
class StochasticActor(tf.keras.Model):
  ...
  def __init__(self, input_dim, action_dim):
    ...
    self.logsig = tf.compat.v1.get_variable(
        name='logsig',
        shape=[1, action_dim],
        dtype=tf.float32,
  ...
  def call(self, inputs):
    ...
    tf.compat.v1.assert_equal(act_mu.shape, act_sig.shape)
  ...
  def __init__(self, input_dim):
    ...
    self.main = tf.keras.Sequential([
        ...
        tf.compat.v1.layers.Dense(
            ...
            kernel_initializer=tf.compat.v1.orthogonal_initializer()),
        tf.compat.v1.layers.Dense(
            units=1, kernel_initializer=tf.compat.v1.orthogonal_initializer())
    ])
